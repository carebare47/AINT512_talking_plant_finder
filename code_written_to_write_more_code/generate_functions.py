...
print("const char *plantLocationStringArray[8];")
print("")
envCounter = 1
x = 1
print("if (!strcmp(buf, \"%s\")) {" % a[x])
x = x - 1
print("AppAppendTTSPrompt(app, \"You said %s.\");" % a[x])
print("printf(\"You said %s.\\n\");" % a[x])
#print("plantLocationStringArray[envCounter] = \"%s\";" % a[counter2])
print("strcpy(plantLocationStringArray[envCounter], \"%s\");" % a[counter2])
counter2 = counter2 + 1
print("envCounter = envCounter + 1;")
print("AppGoto(app, \"%s\");" % appgoto)
print("}")

x = 3
while(x < 2*len(a)/3):
	print("else if (!strcmp(buf, \"%s\")) {" % a[x])
	#x = x - 1
	print("AppAppendTTSPrompt(app, \"You said %s.\");" % a[x-1])
	print("printf(\"You said %s.\\n\");" % a[x])
	#print("plantLocationStringArray[envCounter] = \"%s\";" % a[counter2])
	print("strcpy(plantLocationStringArray[envCounter], \"%s\");" % a[counter2])
	counter2 = counter2 + 1
